...

{
  ...
  },
  {
    ...
    "title": "Сложение дробей 2",
    "theme": "Дроби",
    "text": "Вычислите: $$\\frac{1}{{var1-10}} + \\frac{1}{2}$$ Ответ - десятичная дробь через точку!",
  ...
  },
  {
    ...
    "title": "Вычитание дробей 2", 
    "theme": "Дроби",
    "text": "Вычислите: $$\\frac{{var1-10}}{4} - \\frac{1}{2}$$ Ответ - десятичная дробь через точку!",
  ...
  },
  {
    ...
    "theme": "Дроби",
    "text": "Вычислите: $$\\frac{{var1-10}}{3} \\times \\frac{6}{{var1-10}}$$ Ответ - десятичная дробь через точку!",
  ...
  },
  {
    ...
    "theme": "Дроби",
    "text": "Вычислите: $$\\frac{{var1-10}}{2} \\div \\frac{{var1-10}}{4}$$ Ответ - десятичная дробь через точку!",
  ...
  },
  {
    ...
    "theme": "Дроби", 
    "text": "Вычислите: $$\\frac{1}{{var1-10}} \\times ({var1-10} + {= {var1-10}*2})$$ Ответ - десятичная дробь через точку!",
  ...
  },
  {
    ...
    "theme": "Дроби",
    "text": "Сократите дробь: $$\\frac{{= {var1-10}*2}}{{= {var1-10}*3}}$$ Ответ - десятичная дробь через точку!",
    "answer": "2/3",
  ...
  },
  {
    ...
    "type": "mathwithrandomnumber",
    "header": "Дроби",
    "title": "Сложение с разными знаменателями 2 Ответ - десятичная дробь через точку!",
    "theme": "Дроби",
  ...
  },
  {
    ...
    "theme": "Дроби",
    "text": "Вычислите: $$\\frac{{var1-10}}{2} + \\frac{{= {var1-10}*3}}{2}$$ Ответ - десятичная дробь через точку!",
...

{
  ...
  },
 {
  ...
  "type": "mathwithrandomnumber",
  "header": "Квадратные уравнения",
  "title": "Наибольший корень 5",
  "theme": "Квадратные уравнения",
  "text": "Найдите наибольший корень уравнения: $$x^2 - {= 2*{var1-10} + 2}x + {= {var1-10}*({var1-10}+2)} = 0$$",
  "answer": "{var1-10}+2",
  "hint": "<p><strong>Способ 1: Теорема Виета</strong></p><p>Шаг 1: Записываем условия теоремы Виета</p>$$x_1 + x_2 = {= 2*{var1-10} + 2}, \\quad x_1 \\cdot x_2 = {= {var1-10}*({var1-10}+2)}$$<p>Шаг 2: Подбираем числа, удовлетворяющие условиям</p><p>Ищем два числа, сумма которых {= 2*{var1-10} + 2}, а произведение {= {var1-10}*({var1-10}+2)}</p><p>Подходят числа: {var1-10} и {= {var1-10}+2}, так как:</p><p>{var1-10} + {= {var1-10}+2} = {= 2*{var1-10} + 2}, {var1-10} × {= {var1-10}+2} = {= {var1-10}*({var1-10}+2)}</p><p>Шаг 3: Записываем корни</p>$$x_1 = {var1-10}, \\quad x_2 = {= {var1-10}+2}$$<p><strong>Способ 2: Через дискриминант</strong></p><p>Шаг 1: Записываем коэффициенты</p><p>a = 1, b = -{= 2*{var1-10} + 2}, c = {= {var1-10}*({var1-10}+2)}</p><p>Шаг 2: Вычисляем дискриминант</p>$$D = b^2 - 4ac = (-{= 2*{var1-10} + 2})^2 - 4 \\cdot 1 \\cdot {= {var1-10}*({var1-10}+2)}$$$$D = {= (2*{var1-10}+2)*(2*{var1-10}+2)} - {= 4*{var1-10}*({var1-10}+2)}$$$$D = {= 4*{var1-10}*{var1-10} + 8*{var1-10} + 4} - {= 4*{var1-10}*{var1-10} + 8*{var1-10}} = 4$$<p>Шаг 3: Находим корни</p>$$x = \\frac{-b \\pm \\sqrt{D}}{2a} = \\frac{{= 2*{var1-10} + 2} \\pm \\sqrt{4}}{2} = \\frac{{= 2*{var1-10} + 2} \\pm 2}{2}$$$$x_1 = \\frac{{= 2*{var1-10} + 2} - 2}{2} = \\frac{{= 2*{var1-10}}}{2} = {var1-10}$$$$x_2 = \\frac{{= 2*{var1-10} + 2} + 2}{2} = \\frac{{= 2*{var1-10}+4}}{2} = {= {var1-10}+2}$$<p>Наибольший корень: {= {var1-10}+2}</p>",
  "randomfrom": [2, 3, 4, 5, 6, 7]
},

{
  ...
  "type": "mathwithrandomnumber",
  "header": "Квадратные уравнения",
  "title": "Наименьший корень 5",
  "theme": "Квадратные уравнения",
  "text": "Найдите наименьший корень уравнения: $$x^2 - {= 2*{var1-10} + 2}x + {= {var1-10}*({var1-10}+2)} = 0$$",
  "answer": "{var1-10}",
  "hint": "<p><strong>Способ 1: Теорема Виета</strong></p><p>Шаг 1: Записываем условия теоремы Виета</p>$$x_1 + x_2 = {= 2*{var1-10} + 2}, \\quad x_1 \\cdot x_2 = {= {var1-10}*({var1-10}+2)}$$<p>Шаг 2: Подбираем числа, удовлетворяющие условиям</p><p>Ищем два числа, сумма которых {= 2*{var1-10} + 2}, а произведение {= {var1-10}*({var1-10}+2)}</p><p>Подходят числа: {var1-10} и {= {var1-10}+2}, так как:</p><p>{var1-10} + {= {var1-10}+2} = {= 2*{var1-10} + 2}, {var1-10} × {= {var1-10}+2} = {= {var1-10}*({var1-10}+2)}</p><p>Шаг 3: Записываем корни</p>$$x_1 = {var1-10}, \\quad x_2 = {= {var1-10}+2}$$<p><strong>Способ 2: Через дискриминант</strong></p><p>Шаг 1: Записываем коэффициенты</p><p>a = 1, b = -{= 2*{var1-10} + 2}, c = {= {var1-10}*({var1-10}+2)}</p><p>Шаг 2: Вычисляем дискриминант</p>$$D = b^2 - 4ac = (-{= 2*{var1-10} + 2})^2 - 4 \\cdot 1 \\cdot {= {var1-10}*({var1-10}+2)}$$$$D = {= (2*{var1-10}+2)*(2*{var1-10}+2)} - {= 4*{var1-10}*({var1-10}+2)}$$$$D = {= 4*{var1-10}*{var1-10} + 8*{var1-10} + 4} - {= 4*{var1-10}*{var1-10} + 8*{var1-10}} = 4$$<p>Шаг 3: Находим корни</p>$$x = \\frac{-b \\pm \\sqrt{D}}{2a} = \\frac{{= 2*{var1-10} + 2} \\pm \\sqrt{4}}{2} = \\frac{{= 2*{var1-10} + 2} \\pm 2}{2}$$$$x_1 = \\frac{{= 2*{var1-10} + 2} - 2}{2} = \\frac{{= 2*{var1-10}}}{2} = {var1-10}$$$$x_2 = \\frac{{= 2*{var1-10} + 2} + 2}{2} = \\frac{{= 2*{var1-10}+4}}{2} = {= {var1-10}+2}$$<p>Наибольший корень: {= {var1-10}+2}</p>",
  "randomfrom": [2, 3, 4, 5, 6, 7]
},
...

 {
...

  {
    ...
    "type": "multiplechoices",
    "header": "Производная и касательная",
    "title": "Определение производной в точке 2",
    "theme": "Производная",
    "functionGraph": "true",
    "text": "Чему равен тангенс угла наклона касательной к графику функции y = x² в точке x = 1?",
    "functionType": "quadratic",
    "func": (x) => x * x,
    "pointX": 0,
    "choices": [
    ...
    "type": "multiplechoices",
    "header": "Производная и касательная",
    "title": "Определение производной в точке 3",
    "theme": "Производная",
    "functionGraph": "true",
    "text": "Чему равен тангенс угла наклона касательной к графику функции y = x² в точке x = -1?",
    "functionType": "quadratic",
