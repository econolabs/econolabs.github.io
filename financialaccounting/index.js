...
function LoginLogout() {
    ...
    if (applicationSelector?.modal?.component !== "LoginLogout") return null
...
function EditRecordComment() {
    ...
    if (applicationSelector?.modal?.component !== "EditRecordComment") {
        return null
    }
...
function EditRecordType() {
    ...
    if (applicationSelector?.modal?.component !== "EditRecordType") return null
