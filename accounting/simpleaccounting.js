(function () {
    ...
    */
    ...
    async function updateNodes({ base = "", updates = { temp: "temp" } }) {
        let fireUpdates = {};
  ...
  <tbody>
    ...
    function addRecord(e) {
        e.preventDefault();
        let record = {
            d: contoArray.find(item => $("#ds").value === item.id).name,
            k: contoArray.find(item => $("#ks").value === item.id).name,
            sum: $("#sum").value,
    ...
    function addConto(e) {
        ...
        if (
            ...
            && $("#contotype").value.length > 3
            && $("#sortby").value.length > 3
            && $("#name").value.length > 3
        ) {
            let newconto = {
                conto: $("#conto").value,
                type: $("#contotype").value,
                sortby: $("#sortby").value,
                name: $("#name").value,
                id: getFirebaseNodeKey("temp")
            };
            ...
            let updates = {};
            updates["usersCraft/" + userEmail + "/conto/" + newconto.id] = newconto;
    ...
    */
    ...
    $("#addrecord").addEventListener("click", (e) => addRecord(e), false);
    ...
    */
    ...
    async function initialLoad() {
        ...
        if (!res) {
            ...
            let userContoResp = await getFirebaseNode({
                url: "/usersCraft/" + res.userEmail + "/conto",
                type: "array"
            });
            ...
            //      let updates = {};
            // updates["usersCraft/" + res.userEmail + "/conto/" + "2"] =  { id: 2, name: "Основные средства", type: 'asset' };
            // updates["usersCraft/" + res.userEmail + "/conto/" + "3"] =      { id: 3, name: "Материалы", type: 'asset' };
