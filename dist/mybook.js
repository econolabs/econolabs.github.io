...
If you have multiple apis, you *have* to specify the reducerPath option when using createApi!` : ""}`);
    ...
    */
    ...
    function doSavePost() {
        ...
        // console.log($("#mediatheme").value);
        // console.log($("#mediatitle").value);
    ...
    $("#editPost").addEventListener("click", (e) => doEditPost(), false);
    $("#savePost").addEventListener("click", (e) => doSavePost(), false);
    $("#newMediaPost").addEventListener("click", (e) => doCreateNewPost(), false);
