...

{
    ...
    "hint": `<div class="card border-primary mb-3">
        <div class="card-header bg-primary text-white">
            <strong>📐 Общий вид линейной функции</strong>
        </div>
        <div class="card-body">
            <p class="card-text">Линейная функция имеет вид:</p>
            <p class="text-center fs-3">$y = kx + b$</p>
            <ul>
                <li><strong>$k$</strong> — угловой коэффициент (тангенс угла наклона прямой)</li>
                <li><strong>$b$</strong> — свободный член (точка пересечения с осью $Oy$)</li>
            </ul>
        </div>
    </div>
    ...
    <div class="card border-success mb-3">
        <div class="card-header bg-success text-white">
            <strong>📊 Геометрический смысл коэффициентов</strong>
        </div>
        <div class="card-body">
            <p class="card-text">Графиком линейной функции является <strong>прямая линия</strong>.</p>
            <div class="row mt-3">
                <div class="col-md-6">
                    <div class="alert alert-primary">
                        <strong>Коэффициент $k$:</strong>
                        <ul class="mb-0 mt-1">
                            <li>при $k > 0$ — функция возрастает</li>
                            <li>при $k < 0$ — функция убывает</li>
                            <li>$k = \\tan(\\alpha)$, где $\\alpha$ — угол наклона</li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="alert alert-secondary">
                        <strong>Коэффициент $b$:</strong>
                        <ul class="mb-0 mt-1">
                            <li>точка пересечения с осью $Oy$: $(0; b)$</li>
                            <li>при $b = 0$ — прямая проходит через начало координат</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="card border-secondary">
        <div class="card-header bg-secondary text-white">
            <strong>💡 Определение по графику</strong>
        </div>
        <div class="card-body">
            <p class="card-text">В данном случае на графике представлена <strong class="text-success">прямая линия</strong>, что соответствует <strong>линейной функции</strong> $y = kx + b$.</p>
            <p class="mt-2 mb-0">Для функции $f(x) = 4x$:</p>
            <ul class="mb-0">
                <li>$k = 4$ (угловой коэффициент)</li>
                <li>$b = 0$ (прямая проходит через начало координат)</li>
            </ul>
        </div>
    </div>`
},
...

  {
    ...
    "theme": "Анализ графиков функций",
    "functionGraph": "true",
    "text": "Чему равна производная этой функции?",
    "functionType": "linearsimple4",
    "func": "4*x",
    "choices": [
        "2",
    ...
    "hint": `<div class="card border-primary mb-3">
        <div class="card-header bg-primary text-white">
            <strong>📐 Производная линейной функции</strong>
        </div>
        <div class="card-body">
            <p class="card-text">Линейная функция имеет вид:</p>
            <p class="text-center fs-3">$y = kx + b$</p>
            <p class="card-text">Производная линейной функции равна <strong>угловому коэффициенту $k$</strong>:</p>
            <p class="text-center fs-4">$(kx + b)' = k$</p>
            <p>В данном случае $f(x) = 4x$, поэтому:</p>
            <p class="text-center fs-4">$f'(x) = 4$</p>
        </div>
    </div>
    
    <div class="card border-success mb-3">
        <div class="card-header bg-success text-white">
            <strong>📊 Геометрический смысл производной</strong>
        </div>
        <div class="card-body">
            <p class="card-text">Производная функции в точке равна <strong>тангенсу угла наклона касательной</strong> к графику функции в этой точке:</p>
            <p class="text-center fs-4">$f'(x_0) = \\tan(\\alpha)$</p>
            <div class="row mt-3">
                <div class="col-md-6">
                    <div class="alert alert-primary">
                        <strong>📈 Для линейной функции:</strong>
                        <ul class="mb-0 mt-1">
                            <li>касательная совпадает с самой прямой</li>
                            <li>производная постоянна во всех точках</li>
                            <li>$k = \\tan(\\alpha)$ — тангенс угла наклона</li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="alert alert-secondary">
                        <strong>🔢 Значение производной:</strong>
                        <ul class="mb-0 mt-1">
                            <li>$f'(x) = 4$ означает, что угол наклона $\\alpha = \\arctan(4) \\approx 76°$</li>
                            <li>функция возрастает, так как $k > 0$</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="card border-secondary">
        ...
        <div class="card-body">
            <p class="card-text mb-0">Производная функции $f(x) = 4x$: <strong class="text-success">$f'(x) = 4$</strong></p>
            <p class="mt-2 mb-0 text-muted">Правильный ответ: <strong>4</strong></p>
        </div>
    </div>`
},

{
    "id": "functiongraph00102",
    "type": "multiplechoices",
    "header": "Анализ графиков функций",
    "title": "Определение производной функции по графику 2",
    "theme": "Анализ графиков функций",
    "functionGraph": "true",
    "text": "Чему равна вторая производная этой функции?",
    "functionType": "linearsimple4",
    "func": "4*x",
    "choices": [
        "2",
    ...
    "hint": `<div class="card border-primary mb-3">
        <div class="card-header bg-primary text-white">
            <strong>📐 Вторая производная линейной функции</strong>
        </div>
        <div class="card-body">
            <p class="card-text">Линейная функция имеет вид:</p>
            <p class="text-center fs-3">$y = kx + b$</p>
            <p class="card-text">Найдём последовательно производные:</p>
            <ul>
                <li>Первая производная: <strong>$f'(x) = k$</strong> (угловой коэффициент)</li>
                <li>Вторая производная: <strong>$f''(x) = 0$</strong> (производная постоянной величины)</li>
            </ul>
            <p>В данном случае $f(x) = 4x$, поэтому:</p>
            <p class="text-center fs-4">$f'(x) = 4$, &nbsp;&nbsp; $f''(x) = 0$</p>
        </div>
    </div>
    
    <div class="card border-success mb-3">
        <div class="card-header bg-success text-white">
            <strong>📊 Геометрический и физический смысл второй производной</strong>
        </div>
        <div class="card-body">
            <div class="row mt-2">
                <div class="col-md-6">
                    <div class="alert alert-primary">
                        ...
                        <ul class="mb-0 mt-1">
                            <li>вторая производная характеризует <strong>выпуклость</strong> функции</li>
                            <li>при $f''(x) = 0$ график не имеет изгиба (прямая линия)</li>
                            <li>для линейной функции кривизна равна нулю</li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="alert alert-secondary">
                        <strong>⚙️ Физический смысл:</strong>
                        <ul class="mb-0 mt-1">
                            <li>первая производная — скорость изменения функции</li>
                            <li>вторая производная — <strong>ускорение</strong> (скорость изменения скорости)</li>
                            <li>при $f''(x) = 0$ движение происходит с постоянной скоростью</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="alert alert-success mt-3">
                <strong>📌 Важно:</strong> Вторая производная линейной функции всегда равна нулю, так как скорость её изменения (первая производная) является постоянной величиной.
            </div>
        </div>
    </div>
    ...
    <div class="card border-secondary">
        ...
        <div class="card-body">
            <p class="card-text mb-0">Вторая производная функции $f(x) = 4x$: <strong class="text-success">$f''(x) = 0$</strong></p>
            <p class="mt-2 mb-0 text-muted">Правильный ответ: <strong>0</strong></p>
        </div>
    </div>`
},

  {
    ...
    "type": "multiplechoices",
    "header": "Анализ графиков функций",
    "title": "Определение первообразной функции по графику 1",
    "theme": "Анализ графиков функций",
    "functionGraph": "true",
    "text": "Чему равна первообразная функции $f(x) = 4x$?",
    "functionType": "linearsimple4",
    "func": "4*x",
    "choices": [
        "$2x^2 + C$",
    ...
    "hint": `<div class="card border-primary mb-3">
        <div class="card-header bg-primary text-white">
            <strong>📐 Формула первообразной</strong>
        </div>
        <div class="card-body">
            <p class="card-text">Первообразная для функции $f(x) = kx$ находится по формуле:</p>
            <p class="text-center fs-4">$\int kx \, dx = \frac{kx^2}{2} + C$</p>
            <p>В данном случае $k = 4$, поэтому:</p>
            <p class="text-center fs-4">$\int 4x \, dx = \frac{4x^2}{2} + C = 2x^2 + C$</p>
        </div>
    </div>
    
    <div class="card border-success mb-3">
        <div class="card-header bg-success text-white">
            <strong>📊 Геометрический смысл интеграла</strong>
        </div>
        <div class="card-body">
            <p class="card-text">Определённый интеграл $\int_a^b f(x) \, dx$ численно равен <strong>площади криволинейной трапеции</strong>, ограниченной:</p>
            <ul>
                <li>графиком функции $y = f(x)$,</li>
                <li>осью $Ox$,</li>
                <li>вертикальными прямыми $x = a$ и $x = b$.</li>
            </ul>
            <p class="mt-2">Площадь под графиком $f(x) = 4x$ на отрезке $[a, b]$ вычисляется через первообразную:</p>
            <p class="text-center fs-5">$F(b) - F(a) = (2b^2 + C) - (2a^2 + C) = 2(b^2 - a^2)$</p>
            <div class="alert alert-secondary mt-2" role="alert">
                <strong>Пример:</strong> При $a = 0$, $b = 2$ площадь под графиком равна $2(2^2 - 0^2) = 2 \cdot 4 = 8$ квадратных единиц.
            </div>
        </div>
    </div>
    ...
    <div class="card border-secondary">
        ...
        <div class="card-body">
            <p class="card-text mb-0">Первообразная функции $f(x) = 4x$: <strong class="text-success">$2x^2 + C$</strong></p>
        </div>
    </div>`
},
