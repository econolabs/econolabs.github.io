(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.basicfirebasecrudservices = factory());
    ...
    if (getApps().length > 1) {
      deleteApp(getApps()[1]).then(function () {
        console.log("App deleted successfully");
      }).catch(function (error) {
        console.log("Error deleting app:", error);
      });
    ...
    async function updateFirebaseNode(updates = {
      temp: "temp"
    }) {
      try {
    ...
    return basicfirebasecrudservices;
