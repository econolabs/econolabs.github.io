let quizesSets = [
  ...
  },
  {
    ...
    "type": "mathwithrandomnumber",
    "header": "Системы уравнений",
    "title": "Пропорциональные уравнения",
    "theme": "Системы уравнений",
    "text": "Решите систему уравнений: $$\\begin{cases} 2x + y = {= {var1-10}+8} \\\\ 4x + 2y = {= {var1-10}*2+16} \\end{cases}$$ Найдите x",
    "answer": "Любое число",
    "hint": "<p><strong>Анализ системы</strong></p><p>Второе уравнение является удвоенным первым:</p><p>2 × (2x + y) = 2 × {= {var1-10}+8} = {= {var1-10}*2+16}</p><p>Система имеет бесконечно много решений</p><p>Ответ: x - любое число</p>",
    "randomfrom": [2, 4, 6, 8]
  },
  {
    "id": "system015",
  ...
  },
  {
    ...
    "theme": "Системы уравнений",
    "text": "Решите систему уравнений: $$\\begin{cases} 4x - 2y = {= {var1-10}*2} \\\\ 6x - 3y = {= {var1-10}*3} \\end{cases}$$ Найдите y",
    "answer": "Любое число",
    "hint": "<p><strong>Анализ системы</strong></p><p>Второе уравнение является умноженным на 1.5 первым:</p><p>1.5 × (4x - 2y) = 1.5 × {= {var1-10}*2} = {= {var1-10}*3}</p><p>Система имеет бесконечно много решений</p><p>Ответ: y - любое число</p>",
    "randomfrom": [2, 4, 6, 8]
  },
  {
    "id": "system021",
