...

{
  ...
  "hint": `<p>Нахождение площади равнобедренной трапеции:</p>
    <svg width="280" height="200" viewBox="0 0 280 200">
      ...
      <!-- Вычисления -->
      <rect x="40" y="30" width="200" height="100" fill="#fff9c4" stroke="#ff9800" stroke-width="1"/>
      <text x="50" y="45" font-size="10" fill="#2e7d32">1. Находим проекцию боковой стороны:</text>
      <text x="50" y="60" font-size="12" fill="#d32f2f">x = (a - b) ÷ 2 = (20 - 10) ÷ 2 = 5 см</text>
      <text x="50" y="75" font-size="10" fill="#2e7d32">2. Находим высоту по теореме Пифагора:</text>
      <text x="50" y="90" font-size="12" fill="#388e3c">h = √(c² - x²) = √(169 - 25) = √144 = 12 см</text>
      <text x="50" y="105" font-size="10" fill="#2e7d32">3. Находим площадь трапеции:</text>
      <text x="50" y="120" font-size="14" fill="#1976d2">S = (a + b) × h ÷ 2 = (20 + 10) × 12 ÷ 2</text>
      <text x="50" y="135" font-size="16" fill="#d32f2f" font-weight="bold">S = 30 × 6 = 120 см²</text>
    </svg>
    <ul>
...

{
  ...
  "theme": "Геометрия",
  "text": "В треугольнике \(ABC\) угол \(A\) равен \(30^{\\circ}\), угол \(B\) равен \(70^{\\circ}\). Найти угол \(C\).",
  "answer": "180-30-70",
  "hint": "Сумма углов в любом треугольнике равна \(180^{\\circ}\)<br>Чтобы найти угол \(C\), вычтите из 180° сумму известных углов:<br>$$C = 180^{\\circ} - (A + B) = 180^{\\circ} - (30^{\\circ} + 70^{\\circ})$$<br>$$C = 180^{\\circ} - 100^{\\circ} = 80^{\\circ}$$",
...

{
  ...
  "title": "Нахождение угла треугольника",
  "theme": "Геометрия", 
  "text": "В треугольнике два угла равны {var1-10}\(^{\\circ}\) и 50\(^{\\circ}\). Найти третий угол.",
  "answer": "180-{var1-10}-50",
  "hint": "Сумма углов треугольника равна \(180^{\\circ}\)<br>Третий угол = $$180^{\\circ} - {var1-10}^{\\circ} - 50^{\\circ} = {=180-var1-10-50}^{\\circ}$$",
...

{
  ...
  "theme": "Геометрия", 
  "text": "В треугольнике два угла равны \(30^{\\circ}\) и \({var1-10}^{\\circ}\). Найти третий угол.",
  "answer": "180-30-{var1-10}",
  "hint": "Сумма углов треугольника равна \(180^{\\circ}\)<br>Третий угол = $$180^{\\circ} - 30^{\\circ} - {var1-10}^{\\circ} = {=180-30-var1-10}^{\\circ}$$",
...

{
  ...
  "hint": `<p>Нахождение площади равнобедренного треугольника:</p>
    <svg width="280" height="200" viewBox="0 0 280 200">
      ...
      <!-- Вычисления -->
      <rect x="40" y="30" width="200" height="100" fill="#fff9c4" stroke="#ff9800" stroke-width="1"/>
      <text x="50" y="45" font-size="10" fill="#2e7d32">1. Находим высоту по теореме Пифагора:</text>
      <text x="50" y="60" font-size="12" fill="#d32f2f">h = √(10² - 6²) = √(100 - 36) = √64 = 8 см</text>
      <text x="50" y="75" font-size="10" fill="#2e7d32">2. Находим площадь треугольника:</text>
      <text x="50" y="90" font-size="14" fill="#388e3c">S = (основание × высота) ÷ 2</text>
      <text x="50" y="105" font-size="16" fill="#1976d2">S = (12 × 8) ÷ 2 = 96 ÷ 2 = 48 см²</text>
      <text x="50" y="120" font-size="16" fill="#d32f2f" font-weight="bold">Ответ: 48 см²</text>
    </svg>
    <ul>
...

{
  ...
  "hint": `<p>Решение задачи с трапецией и биссектрисой:</p>
    <svg width="280" height="200" viewBox="0 0 280 200">
      ...
      <!-- Вычисления -->
      <rect x="40" y="120" width="200" height="70" fill="#e8f5e8" stroke="#2e7d32" stroke-width="1"/>
      <text x="50" y="135" font-size="10" fill="#2e7d32">1. ∠DAC = 45° (биссектриса прямого угла)</text>
      <text x="50" y="150" font-size="10" fill="#2e7d32">2. В ΔADC: ∠D = 60°, ∠A = 45° ⇒ ∠C = 75°</text>
      <text x="50" y="165" font-size="10" fill="#2e7d32">3. AD = AC × cos45° = 6 × (√2/2) = 3√2 см</text>
      <text x="50" y="180" font-size="10" fill="#2e7d32">4. CD = AC × sin45° ÷ sin60° = (3√2) ÷ (√3/2) = 2√6 см</text>
      <text x="50" y="195" font-size="10" fill="#d32f2f">5. S = ½ × (AD + BC) × AB = 27√3 см²</text>
    </svg>
    <ul>
...

{
  ...
  "hint": `<p>Решение задачи:</p>
    <svg width="280" height="200" viewBox="0 0 280 200">
      ...
      <!-- Вычисления -->
      <rect x="40" y="30" width="200" height="100" fill="#e8f5e8" stroke="#2e7d32" stroke-width="1"/>
      <text x="50" y="45" font-size="10" fill="#2e7d32">1. Радиус окружности = половине стороны квадрата:</text>
      <text x="50" y="60" font-size="12" fill="#d32f2f">R = 8 ÷ 2 = 4 см</text>
      <text x="50" y="75" font-size="10" fill="#2e7d32">2. В прямоугольном треугольнике с углом 30°:</text>
      <text x="50" y="90" font-size="12" fill="#388e3c">гипотенуза = 2R = 8 см (диаметр)</text>
      <text x="50" y="105" font-size="12" fill="#1976d2">катет против 30° = 4 см, другой катет = 4√3 см</text>
      <text x="50" y="120" font-size="14" fill="#d32f2f" font-weight="bold">S = ½ × 4 × 4√3 = 8√3 см²</text>
    </svg>
    <ul>
...

{
  ...
  "hint": `<p>Решение задачи с медианой в равнобедренном треугольнике:</p>
    <svg width="280" height="200" viewBox="0 0 280 200">
      ...
      <!-- Вычисления -->
      <rect x="40" y="30" width="200" height="120" fill="#e8f5e8" stroke="#2e7d32" stroke-width="1"/>
      <text x="50" y="45" font-size="10" fill="#2e7d32">1. В прямоугольном треугольнике (медиана, боковая сторона, половина основания):</text>
      <text x="50" y="60" font-size="12" fill="#d32f2f">(½ основания)² = 13² - 5² = 169 - 25 = 144</text>
      <text x="50" y="75" font-size="12" fill="#388e3c">½ основания = √144 = 12 см</text>
      <text x="50" y="90" font-size="12" fill="#1976d2">основание = 2 × 12 = 24 см</text>
      <text x="50" y="105" font-size="10" fill="#2e7d32">2. Площадь через медиану и основание:</text>
      <text x="50" y="120" font-size="12" fill="#d32f2f">S = ½ × медиана × основание = ½ × 5 × 24 = 60 см²</text>
      <text x="50" y="135" font-size="10" fill="#2e7d32">3. Периметр:</text>
      <text x="50" y="150" font-size="14" fill="#388e3c" font-weight="bold">P = 13 + 13 + 24 = 50 см</text>
    </svg>
    <ul>
...

{
  ...
  "hint": `<p>Решение задачи с ромбом:</p>
    <svg width="280" height="200" viewBox="0 0 280 200">
      ...
      <!-- Вычисления -->
      <rect x="40" y="30" width="200" height="100" fill="#e8f5e8" stroke="#2e7d32" stroke-width="1"/>
      <text x="50" y="45" font-size="10" fill="#2e7d32">1. Площадь ромба через диагонали:</text>
      <text x="50" y="60" font-size="12" fill="#d32f2f">S = ½ × d₁ × d₂ = ½ × 8 × 6 = 24 см²</text>
      <text x="50" y="75" font-size="10" fill="#2e7d32">2. Сторона ромба по теореме Пифагора:</text>
      <text x="50" y="90" font-size="12" fill="#388e3c">a = √((d₁/2)² + (d₂/2)²) = √(4² + 3²) = √(16 + 9) = √25 = 5 см</text>
      <text x="50" y="105" font-size="10" fill="#2e7d32">3. Периметр ромба:</text>
      <text x="50" y="120" font-size="14" fill="#1976d2" font-weight="bold">P = 4 × a = 4 × 5 = 20 см</text>
    </svg>
    <ul>
...

{
  ...
  "hint": `<p>Решение задачи с трапецией:</p>
    <svg width="280" height="200" viewBox="0 0 280 200">
      ...
      <!-- Вычисления -->
      <rect x="40" y="30" width="200" height="120" fill="#e8f5e8" stroke="#2e7d32" stroke-width="1"/>
      <text x="50" y="45" font-size="10" fill="#2e7d32">1. В прямоугольном ΔACD (∠ACD = 90°):</text>
      <text x="50" y="60" font-size="12" fill="#d32f2f">CD = AD × cos30° = 12 × (√3/2) = 6√3 см</text>
      <text x="50" y="75" font-size="12" fill="#388e3c">AC = AD × sin30° = 12 × 0,5 = 6 см</text>
      <text x="50" y="90" font-size="10" fill="#2e7d32">2. В равнобедренной трапеции боковые стороны равны:</text>
      <text x="50" y="105" font-size="12" fill="#1976d2">AB = CD = 6√3 см</text>
      <text x="50" y="120" font-size="10" fill="#2e7d32">3. Находим высоту трапеции из ΔACD:</text>
      <text x="50" y="135" font-size="12" fill="#ff9800">h = AC × sin30° = 6 × 0,5 = 3 см</text>
      <text x="50" y="150" font-size="10" fill="#2e7d32">4. Площадь трапеции:</text>
      <text x="50" y="165" font-size="14" fill="#d32f2f" font-weight="bold">S = ½ × (AB + CD) × h = ½ × (6√3 + 6√3) × 3 = 18√3 см</text>
    </svg>
    <ul>
...

{
  ...
  "hint": `<p>Решение задачи:</p>
    <svg width="280" height="200" viewBox="0 0 280 200">
      ...
      <!-- Вычисления -->
      <rect x="40" y="30" width="200" height="120" fill="#e8f5e8" stroke="#2e7d32" stroke-width="1"/>
      <text x="50" y="45" font-size="10" fill="#2e7d32">1. В прямоугольном треугольнике с катетами 4 см:</text>
      <text x="50" y="60" font-size="12" fill="#d32f2f">гипотенуза = √(4² + 4²) = √32 = 4√2 см</text>
      <text x="50" y="75" font-size="10" fill="#2e7d32">2. Радиус описанной окружности:</text>
      <text x="50" y="90" font-size="12" fill="#388e3c">R = гипотенуза/2 = (4√2)/2 = 2√2 см</text>
      <text x="50" y="105" font-size="10" fill="#2e7d32">3. Сторона описанного правильного шестиугольника:</text>
      <text x="50" y="120" font-size="12" fill="#1976d2">a = 2R/√3 = (4√2)/√3 см</text>
      <text x="50" y="135" font-size="10" fill="#2e7d32">4. Площадь правильного шестиугольника:</text>
      <text x="50" y="150" font-size="14" fill="#ff9800" font-weight="bold">S = (3√3/2) × a² = (3√3/2) × (32/3) = 16√3 см²</text>
    </svg>
    <ul>
