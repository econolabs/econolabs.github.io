...

{
  ...
  },
  {
    ...
    theme: "Тригонометрия прямоугольного треугольника",
    text: "Найдите приближенное значение угла B в градусах, если sin(∠B) = 3/5.",
       "JSXGraph": "true",
    "JSXGraphType": "triangle345",
    hint: "Используйте обратную функцию: $$\\angle B = \\arcsin\\left(\\frac{3}{5}\\right)$$. $$\\arcsin(0.6) \\approx 36.87^\\circ$$",
    choices: [
      "30°",
      "36.87°",
      "45°",
